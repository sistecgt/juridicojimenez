      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-10 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p><a href="#consulta" class="btn btn-primary py-3 px-4">Consultas</a></p>           
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container-fluid">
    		<div class="row d-flex">
    			<div class="col-md-6 d-flex">
    				<div class="img d-flex align-self-stretch align-items-center justify-content-center" style="background-image:url(images/rony_1.jpg); background-size: 65%;">
        ...
        <div class="row d-flex justify-content-center">
        	...
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
        			...
        			<h3><a href="#">Violencia Contra La Mujer</a></h3>
        		</div>
        	</div>
        	<div class="col-md-3 col-lg-2 text-center">
        		<div class="practice-area ftco-animate">
    ...
    <section class="ftco-section bg-secondary">
        ...
        <div class="row">
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              <div class="front" style="background-image: url(/images/rony.jpg); background-size: 100% 90%;">
	                <div class="box">
        	...
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              <div class="front" style="background-image: url(/images/sec.jpg);">
	                <div class="box">
	                  <h2>Zoila Eluvia Vivar Najera</h2>
	                  <p>Secretaria</p>
	                </div>
	              </div>
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  ...
	                  <div class="name align-self-center">Zoila Eluvia Vivar Najera<span class="position">Secretaria</span></div>
	                </div>
	              </div>
	            </div>
	          </div>
...
<form action="https://gmail.us20.list-manage.com/subscribe/post?u=e62b8f0f294bacf0a54936c66&amp;id=756e506512" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
<div class="mc-field-group">
	<label for="mce-EMAIL">Correo electrónico </label>
	<input type="email" value="" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Ingrese correo electrónico">
</div>
